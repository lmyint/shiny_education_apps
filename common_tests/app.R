    ...
    tabPanel(
        ...
        sidebarLayout(
            sidebarPanel(
                ...
                actionButton(inputId = "repeat_cont", label = "Repeat 500 times")
            ),
            mainPanel(
    ...
    tabPanel(
        ...
        sidebarLayout(
            sidebarPanel(
                ...
                sliderInput(
                    inputId = "prop_group1",
                    label = "True proportion of cases in group 1",
                    min = 0,
                    max = 1,
                    value = 0.1,
                    step = 0.01
                ...
                actionButton(inputId = "repeat_categ", label = "Repeat 500 times")
            ),
            mainPanel(
